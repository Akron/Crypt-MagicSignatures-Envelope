...
It accepts MagicEnvelopes in the L<XML format|http://salmon-protocol.googlecode.com/svn/trunk/draft-panzer-magicsig-01.html#anchor4>
or an XML document including a
L<MagicEnvelope provenance|http://salmon-protocol.googlecode.com/svn/trunk/draft-panzer-magicsig-01.html#anchor7> element.
...
a L<compact MagicKey string|http://salmon-protocol.googlecode.com/svn/trunk/draft-panzer-magicsig-01.html#rfc.section.8.1>
or a hash reference
...
verify against the base signature string and then will verify against the data on failure
I<(this is implemented for compatibility with non-standard implementations)>.
